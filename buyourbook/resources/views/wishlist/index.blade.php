<x-app-layout>
    ...
    <section class="py-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h1 class="text-2xl font-bold text-gray-900 mb-6">❤️ Mes favoris</h1>
                    ...
                    @foreach($wishlists as $wishlist)
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex flex-col">
                            <div class="flex gap-4">
                                ...
                                @else
                                    <div class="w-16 h-20 bg-gray-100 rounded-lg flex items-center justify-center text-gray-300 flex-shrink-0">📚</div>
                                @endif
                                <div class="min-w-0">
